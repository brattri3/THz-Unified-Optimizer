...
>
> **Решение владельца 2026-08-15 (`CHARTER.md` §12): координацию сессий как процессов ведёт сам
> Claude Code; наш регламент — только предметная работа.** Механизм `.lock`, реестр ников и
> heartbeat отменены. Промты — append-only шаблоны, их текст не переписывается задним числом;
> при использовании **выбрасывайте эти фразы**:
>
