...
1. **Непараксиальность пучка и шумы детектора (Геометрия стенда):**
   Теория Бланко предполагает падение плоской однородной волны на бесконечную решетку. В реальности ТГц-пучок диаметром 12 мм сфокусирован в центре оправы с чистой апертурой 4 дюйма (101.6 мм), поэтому **дифракция на оправе физически полностью исключена**. Высокая корреляция остатков при углах скрещивания $50^\circ\dots 90^\circ$ вызвана непараксиальностью пучка и физическим пределом динамического диапазона (отношением сигнал/шум) примера при глубоком ослаблении.
