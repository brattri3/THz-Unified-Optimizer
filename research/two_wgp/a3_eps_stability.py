...
GROUP = {
    ...
    "purewave": "single_wgp",
    # test_grid_33_11 добавлен 2026-08-06 (A13): восьмой образец, D/P = 0.333 —
    # самый разреженный в проекте, первая ЭКСТРАПОЛЯЦИЯ закона H5 вниз по D/P.
    "test_grid_33_11": "single_wgp",
}
