...
def main():
    ...
    story.append(Paragraph(
        ...
        "1. <i>Непараксиальность пучка и краевая дифракция:</i> Реальный пучок ТГц имеет гауссов профиль конечной ширины. При вращении на большие углы он испытывает краевую дифракцию на металлической оправе окна поляризатора, которая одинакова для обеих серий.<br/>"
