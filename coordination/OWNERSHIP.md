...
- **L = поиск и извлечение (первичка), зона `research/papers/**`.** Находит статьи (metasearch, граф
...
- **Механизм связи:** нужны источники/выжимки, которых нет в `research/papers/**` → D пишет
