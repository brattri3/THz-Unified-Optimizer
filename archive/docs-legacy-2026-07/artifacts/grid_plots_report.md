...
- **Период проволочной решётки ($P$):** 17.500 мкм
- **Диаметр проволоки ($D$):** 5.053 мкм
- **Систематический сдвиг угла ($\theta_{offset}$):** -0.18^\circ
- **Коэффициент поглощения/рассеяния ($loss\_factor$):** 0.287 (степень $\gamma = 1.868$)
