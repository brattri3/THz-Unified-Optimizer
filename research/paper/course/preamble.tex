...
% Числа проекта: каждый учебный тезис опирается на реальный результат
\newtcolorbox{projectfact}[1][]{
  enhanced, breakable, colback=cS3!6, colframe=cS3,
  boxrule=0pt, leftrule=3pt, arc=1pt,
  fonttitle=\bfseries, title={Число проекта#1}, coltitle=cS3!70!black,
  attach boxed title to top left={xshift=6pt,yshift=-2pt},
...
% Ссылка на артефакт проекта — единый способ пометить происхождение числа
\newcommand{\artifact}[1]{{\small\color{cInk2}\texttt{#1}}}

% Термин при первом употреблении (педагогический мандат)
