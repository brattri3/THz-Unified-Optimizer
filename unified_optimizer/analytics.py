    ...
    with open(output_path, "w", encoding="utf-8") as f:
        ...
        for ds, ds_results in results.items():
            ...
            if r1:
                ...
                if r2:
                    f.write(f"| | 2D | {r2['P_eff_um']:.3f} | {r2['D_eff_um']:.3f} | {r2['theta_offset']:.2f} | {r2['loss_factor']:.3f} | {r2['gamma']:.2f} | - | {r2['fun']:.3e} |\n")
            elif r2:
                f.write(f"| **{ds}** | 2D | {r2['P_eff_um']:.3f} | {r2['D_eff_um']:.3f} | {r2['theta_offset']:.2f} | {r2['loss_factor']:.3f} | {r2['gamma']:.2f} | - | {r2['fun']:.3e} |\n")
